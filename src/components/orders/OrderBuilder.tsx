...
export function OrderBuilder({ order, onAdd, onRemove, onAdjust, onClear, savedOrders, onSave, onLoadSaved, onDeleteSaved, mode, isFullWidth, onToggleMode, onAction, busy }: Props) {
  ...
  return (
    <section className="panel panel-corners flex flex-col rounded-md p-4 lg:min-h-0">
      ...
      {savedOrders.length > 0 && (
        <details className="mt-2 rounded border border-white/10 bg-black/25 px-3 py-2">
          <summary className="hud-label cursor-pointer select-none text-accent">📁 Архив рапортов штаба ({savedOrders.length})</summary>
